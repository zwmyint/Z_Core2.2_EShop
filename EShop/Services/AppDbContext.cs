...
namespace EShop.Services
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<m_cls_Category>().HasData(new m_cls_Category { CategoryId = 1, CategoryName = "Chocolate Candy" });
            modelBuilder.Entity<m_cls_Category>().HasData(new m_cls_Category { CategoryId = 2, CategoryName = "Fruit Candy" });
            modelBuilder.Entity<m_cls_Category>().HasData(new m_cls_Category { CategoryId = 3, CategoryName = "Gummy Candy" });
            modelBuilder.Entity<m_cls_Category>().HasData(new m_cls_Category { CategoryId = 4, CategoryName = "Halloween Candy" });
            modelBuilder.Entity<m_cls_Category>().HasData(new m_cls_Category { CategoryId = 5, CategoryName = "Hard Candy" });

            modelBuilder.Entity<m_cls_Candy>().HasData(new m_cls_Candy
            {
                CandyId = 1,
